...
const navLinks = [
  ...
  { label: "Buquês de Flores", href: "/buques" },
]
    ...
    <>
      ...
      <header className="sticky top-0 z-40 border-b border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 lg:py-4">
          {/* Logo */}
          <a href="#" className="flex items-center gap-3" aria-label="Flor do Campo - Página Inicial">
            <Image
              src="/images/Logo.png"
        ...
        {/* Mobile menu */}
        {mobileOpen && (
          <nav className="border-t border-border bg-card px-4 pb-4 md:hidden" aria-label="Menu móvel">
